  ...
  describe('LoadShifts Actions', () => {
    ...
    describe('LoadShiftsSuccess', () => {
      it('should create an action', () => {
        const payload: Shift[] = [
          {
            id: '32a36eb7-3571-4784-927a-c1d608019576', employeeId: '8ae2a281-1555-43fa-bb11-945b51cfdbb5',
            start: 1617834907521, end: 1617834907999
          },
          {
            id: '83bc6c24-201f-44bc-93e8-3d5c1d90f8b5', employeeId: '8ae2a281-1555-43fa-bb11-945b51cfdbb5',
            start: 1617834907521, end: 1617834907999
          },
        ];
